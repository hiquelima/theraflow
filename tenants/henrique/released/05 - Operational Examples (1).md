# 05 - Operational Examples

## Exemplo 1 — Primeiro contato sem nome

Cliente:
Oi, vi o anúncio e queria mais informações.
...
Regra:
Não explicar serviço ainda. Primeiro coletar nome. Cidade é opcional.

---

## Exemplo 2 — Cliente informou só o nome
...
## Exemplo 3 — Cliente pergunta como funciona sem dizer nome

Cliente:
Quero saber como funciona.

Resposta esperada:
Claro, eu te explico com prazer. Antes, só preciso saber como você se chama. Se puder me contar também de qual cidade você é, isso ajuda no atendimento.

Regra:
Não avançar sem nome.
...
Regra:
Retomar somente o pedido do nome.
